...
export function UserListingsTable({ initialListings = [] }) {
  ...
  return (
    <section className="mt-10">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="relative w-full sm:w-80">
          ...
          <input
            ...
            className="h-11 w-full rounded-lg border border-zinc-200 bg-white pl-10 pr-4 text-sm text-zinc-900 shadow-sm outline-none transition-all placeholder:text-zinc-400 focus:border-[#2ed2c3] focus:ring-2 focus:ring-[#2ed2c3]/30"
          />
        </div>
      </div>
      ...
      <div className="mt-5 overflow-hidden rounded-xl bg-white shadow-xl ring-1 ring-black/5">
              ...
              {filtered.length === 0 ? (
                <tr>
                  <td colSpan={5} className="px-6 py-16">
                    <NoMatches onClearQuery={() => setQuery("")} />
                  </td>
                </tr>
              ) : (
                filtered.map((listing) => {
                  ...
                  return (
                    <tr
                      key={listing._id}
                      className="group border-b border-zinc-100 transition-colors duration-150 hover:bg-gray-50 last:border-b-0"
                    >
                      <td className="px-6 py-4 align-top">
                        <div className="flex items-start gap-3">
                          {listing.image ? (
                            ...
                            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-md bg-[#2ed2c3]/10 text-sm font-semibold text-[#1fa99c] ring-1 ring-zinc-200">
...
function EmptyDashboard() {
  return (
    <section className="mt-10">
      <div className="flex flex-col items-center justify-center rounded-xl bg-white px-6 py-20 text-center shadow-xl ring-1 ring-zinc-100">
        <div className="mb-5 flex h-16 w-16 items-center justify-center rounded-full bg-[#2ed2c3]/10 text-[#2ed2c3]">
          <EmptyIcon />
        </div>
        ...
        <p className="mt-2 max-w-md text-sm text-zinc-500">
          Start showcasing your business. Add your first listing to appear in
          search results and reach new customers.
        </p>
        <Link
          href="/add-listing"
          className="mt-6 inline-flex h-11 items-center justify-center rounded-md bg-[#2ed2c3] px-6 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-[#1fa99c]"
        >
          + Add Listing
        </Link>
      </div>
...
function NoMatches({ onClearQuery }) {
  return (
