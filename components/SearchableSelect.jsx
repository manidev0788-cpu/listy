...
export function SearchableSelect({
  ...
  const baseButton =
    "flex h-12 w-full items-center justify-between gap-2 rounded-lg border border-zinc-200 bg-zinc-50 px-3 text-left text-sm text-zinc-900 outline-none transition-colors hover:border-zinc-300 focus:border-[#2ed2c3] focus:bg-white focus:ring-2 focus:ring-[#2ed2c3]/25";
  ...
  return (
    <div ref={wrapperRef} className="relative w-full">
      ...
      {open && (
        <div className="absolute left-0 right-0 top-[calc(100%+6px)] z-40 overflow-hidden rounded-lg border border-zinc-200 bg-white shadow-[0_20px_48px_rgba(0,0,0,0.18)]">
