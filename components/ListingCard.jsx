...
export function ListingCard({ listing }) {
  ...
  return (
    <Link
      href={href}
      className="group flex h-full flex-col overflow-hidden rounded-2xl bg-white shadow-[0_4px_20px_rgba(0,0,0,0.06)] ring-1 ring-zinc-100 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_18px_40px_rgba(0,0,0,0.12)] hover:ring-[#2ed2c3]/30 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#2ed2c3]"
    >
      <div className="relative h-44 w-full overflow-hidden bg-linear-to-br from-[#2ed2c3] to-[#1fa99c]">
        ...
        {category && (
          <span className="absolute left-4 top-4 inline-flex items-center gap-1 rounded-full bg-white/95 px-3 py-1 text-[11px] font-semibold uppercase tracking-wider text-zinc-800 shadow-sm">
            <TagIcon />
            {category}
          </span>
        )}
      ...
      <div className="flex flex-1 flex-col p-5">
        <h3 className="line-clamp-1 text-lg font-semibold text-zinc-900 transition-colors group-hover:text-[#1fa99c]">
